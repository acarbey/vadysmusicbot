...
client.ayarlar = {
	...
	destek: "https://discord.gg/K4hEUtx", // Discord destek sunucunuz
	surum: "0.0.1", // Botunuzun sürümü
	yardimcilar: ["316617336427905024"], // Rozet alıcak ve yetkili Idleri
	...
	oyun: "Vady's Music | www.vadysmusic.com", // Oynuyor yeri, Burayı dilediğiniz şekilde değiştirebilirsiniz.
	oyundurum: "dinliyor", 
	durum: "cevrimici",
  token: "NzE5NTc3MTcyNDEwNDk5MTIz.Xt6HCg.PyxqQGHthq50H7hB8YF7bE60TBU"
}
...
client.elevation = message => {
  ...
  if (message.author.id === "316617336427905024") permlvl = 4;
  return permlvl;
};
...
client.on('message', async msg => {
    ...
    .setTitle(' <:x:474973245477486612> İlk Olarak Sesli Bir Kanala Giriş Yapmanız Gerek.'));
      ...
      .setTitle(`✅ Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!`)
         ...
         .setTitle(`Vady's Bot - Şarkı Seçimi`)
         .setDescription(`${videos.map(video2 => `**${++index} -** ${video2.title}`).join('\n')}`)
         .setFooter('Lütfen 1-3 arasında bir rakam seçiniz 10 saniye içinde liste iptal edilecektir.')
         .setColor('0x36393E'));
          msg.delete(5000)
					try {
            ...
            .setDescription('<:x:474973245477486612> Şarkı Değeri Belirtmediğiniz İçin Seçim İptal Edilmiştir.'));
					...
					return msg.channel.sendEmbed(new Discord.RichEmbed()
          .setColor('0x36393E')
          .setDescription('<:x:474973245477486612> Aradım fakat hiç bir sonuç çıkmadı.'));
                }
            }
   ...
   .setTitle(`:loud_sound: Şuanki Ses Seviyesi: ${serverQueue.volume}`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle(`Vady's Bot - Şarkı Kuyruğu`)
...
function play(guild, song) {
  ...
  .setTitle("**Vady's Bot - Müzik Başladı 🎙**",`https://cdn.discordapp.com/attachments/719046240376979497/719250373675581470/ezgif-6-318cdd01436f.gif`)
